...
class SearchByTitleResponseResultsItemPropertiesDescriptionRichTextItemAnnotations(
    schemas.DictSchema
):
    """
    ...
    ) -> 'SearchByTitleResponseResultsItemPropertiesDescriptionRichTextItemAnnotations':
