...
class DatabaseExecuteQueryResponseResultsItemPropertiesNumberOfMealsRollup(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "number", "function", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "number", "function", ], str]):
    ...
    ) -> 'DatabaseExecuteQueryResponseResultsItemPropertiesNumberOfMealsRollup':
