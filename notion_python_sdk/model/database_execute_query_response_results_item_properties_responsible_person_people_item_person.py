...
class DatabaseExecuteQueryResponseResultsItemPropertiesResponsiblePersonPeopleItemPerson(
    schemas.DictSchema
):
    """
    ...
    ) -> 'DatabaseExecuteQueryResponseResultsItemPropertiesResponsiblePersonPeopleItemPerson':
