...
class CommentCreateNewRequest(
    ...
    rich_text: MetaOapg.properties.rich_text
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rich_text", "parent", "discussion_id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rich_text"]) -> MetaOapg.properties.rich_text: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rich_text", "parent", "discussion_id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        rich_text: typing.Union[MetaOapg.properties.rich_text, str, ],
