...
class CommentGetListResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def results() -> typing.Type['CommentGetListResponseResults']:
                return CommentGetListResponseResults
            next_cursor = schemas.AnyTypeSchema
            has_more = schemas.BoolSchema
            type = schemas.StrSchema
            comment = schemas.DictSchema
            __annotations__ = {
                "object": object,
                "results": results,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'CommentGetListResponseResults': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["object", "results", "next_cursor", "has_more", "type", "comment", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['CommentGetListResponseResults', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["object", "results", "next_cursor", "has_more", "type", "comment", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        results: typing.Union['CommentGetListResponseResults', schemas.Unset] = schemas.unset,
