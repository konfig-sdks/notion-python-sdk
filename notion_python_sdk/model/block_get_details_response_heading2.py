...
class BlockGetDetailsResponseHeading2(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def rich_text() -> typing.Type['BlockGetDetailsResponseHeading2RichText']:
                return BlockGetDetailsResponseHeading2RichText
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rich_text"]) -> 'BlockGetDetailsResponseHeading2RichText': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rich_text"]) -> typing.Union['BlockGetDetailsResponseHeading2RichText', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        rich_text: typing.Union['BlockGetDetailsResponseHeading2RichText', schemas.Unset] = schemas.unset,
