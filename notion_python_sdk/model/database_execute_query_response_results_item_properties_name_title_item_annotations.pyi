...
class DatabaseExecuteQueryResponseResultsItemPropertiesNameTitleItemAnnotations(
    schemas.DictSchema
):
    """
    ...
    ) -> 'DatabaseExecuteQueryResponseResultsItemPropertiesNameTitleItemAnnotations':
