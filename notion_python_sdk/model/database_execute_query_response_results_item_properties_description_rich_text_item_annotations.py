...
class DatabaseExecuteQueryResponseResultsItemPropertiesDescriptionRichTextItemAnnotations(
    schemas.DictSchema
):
    """
    ...
    ) -> 'DatabaseExecuteQueryResponseResultsItemPropertiesDescriptionRichTextItemAnnotations':
