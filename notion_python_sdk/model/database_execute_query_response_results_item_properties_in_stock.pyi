...
class DatabaseExecuteQueryResponseResultsItemPropertiesInStock(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type", "checkbox", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type", "checkbox", ], str]):
    ...
    ) -> 'DatabaseExecuteQueryResponseResultsItemPropertiesInStock':
