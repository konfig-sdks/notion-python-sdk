...
class DatabaseExecuteQueryResponseResultsItemPropertiesDescriptionRichTextItemText(
    schemas.DictSchema
):
    """
    ...
    ) -> 'DatabaseExecuteQueryResponseResultsItemPropertiesDescriptionRichTextItemText':
