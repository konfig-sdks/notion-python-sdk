...
class DatabaseGetDatabaseResponsePropertiesPhoto(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "files", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "type", "files", ], str]):
