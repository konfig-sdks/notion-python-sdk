...
from notion_python_sdk.pydantic.database_execute_query_response_results import DatabaseExecuteQueryResponseResults

class DatabaseExecuteQueryResponse(BaseModel):
    object: typing.Optional[str] = Field(None, alias='object')

    results: typing.Optional[DatabaseExecuteQueryResponseResults] = Field(None, alias='results')
