...
from notion_python_sdk.pydantic.block_append_children_response_results import BlockAppendChildrenResponseResults

class BlockAppendChildrenResponse(BaseModel):
    object: typing.Optional[str] = Field(None, alias='object')

    results: typing.Optional[BlockAppendChildrenResponseResults] = Field(None, alias='results')
