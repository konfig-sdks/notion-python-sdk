...
from notion_python_sdk.model.block_get_children_response import BlockGetChildrenResponse as BlockGetChildrenResponseSchema

from notion_python_sdk.type.block_get_children_response import BlockGetChildrenResponse

from ...api_client import Dictionary
from notion_python_sdk.pydantic.block_get_children_response import BlockGetChildrenResponse as BlockGetChildrenResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BlockGetChildrenResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BlockGetChildrenResponse
...
class GetChildren(BaseApi):
    ...
    async def aget_children(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BlockGetChildrenResponsePydantic:
        ...
        if validate:
            return BlockGetChildrenResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BlockGetChildrenResponsePydantic, raw_response.body)
