...
from notion_python_sdk.model.block_get_details_response import BlockGetDetailsResponse as BlockGetDetailsResponseSchema

from notion_python_sdk.type.block_get_details_response import BlockGetDetailsResponse

from ...api_client import Dictionary
from notion_python_sdk.pydantic.block_get_details_response import BlockGetDetailsResponse as BlockGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = BlockGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BlockGetDetailsResponse
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BlockGetDetailsResponsePydantic:
        ...
        if validate:
            return BlockGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(BlockGetDetailsResponsePydantic, raw_response.body)
